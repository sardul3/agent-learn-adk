...
These pages are generated from `docs/`. Edit the source markdown in the repo; this site will pick up the change.
...
| [Capstone — agent platform curriculum](/reference/capstone-agent-platform-curriculum) | You are ready to build Meridian Foundry, the all-in-one agent platform |
| [Reading list — SA/SWE arsenal](/reference/ai-engineering-reading-list) | You want the curated study/reading list (general + platform-builder) |
